...
public class Form_ThemKichThuoc extends JDialog implements ActionListener{
	...
	public Form_ThemKichThuoc(JPanel parent) throws MalformedURLException, RemoteException, NotBoundException {
		setSize(500, 300);
...
//			JOptionPane.showMessageDialog(this, taoMaLoaiSanPham());
	...
	public String taoMaKichThuoc() throws RemoteException {
